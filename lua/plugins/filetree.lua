...
return {
    ...
    config = function(_, opts)
        ...
        vim.fn.sign_define("DiagnosticSignWarn", { text = visuals.icons.diagnostics.Warn, texthl = "DiagnosticSignWarn" })
        vim.fn.sign_define("DiagnosticSignInfo", { text = visuals.icons.diagnostics.Info, texthl = "DiagnosticSignInfo" })
        vim.fn.sign_define("DiagnosticSignHint", { text = visuals.icons.diagnostics.Hint, texthl = "DiagnosticSignHint" })
