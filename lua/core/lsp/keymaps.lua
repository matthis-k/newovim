...
M.global = {
    { lhs = "gl", rhs = vim.diagnostic.open_float, mode = "n", },
    {
        lhs = "<leader>lk",
        rhs = vim.diagnostic.goto_prev,
        opts = { silent = true, desc = "Go to previous diagnostic", },
        mode =
        "n",
    },
    {
...
M.on_attach = {
    ...
    },
    {
        ...
        mode = "n",
        needs = "documentFormattingProvider",
    },
    {
        lhs = "<space>li",
        rhs = require("core.lsp").toggle_inlay_hints,
        opts = {
            silent = true,
            desc = "Toggle inlay hints",
        },
        mode = "n",
        needs = "textDocument/inlayHint",
    },
}
